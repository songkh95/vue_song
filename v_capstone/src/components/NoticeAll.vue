  ...
  <div id="view" class="notice">
    <section class="notice_all">
      <ul id="lists">
        <!--
    <li id="search">
      <input id="searchInput" type="text" placeholder="제목 | 내용" />
      <img id="searchIcon" src="../assets/search.png" />
      <router-link id="searchAdmin" to="/Notice/create" replace><img src="../assets/setting.png"></router-link>
    </li>
    -->
          ...
          <div id="post">
            <table>
              <tr>
                ...
                -->
                    <img v-if="notice.category == 'question'" src="../assets/noticeQuestion.png" />
                    <img v-else-if="notice.category == 'fix'" src="../assets/noticeFix.png" />
                    <img v-else src="../assets/noticeUtil.png" />
                  </span>
                </td>
